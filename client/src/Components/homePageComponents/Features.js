...
export default function Features() {
  return (
    <div>
      ...
      <div className='flex flex-col sm:flex-row  gap-8 sm:justify-center sm:gap-20 '>
        <div className='flex flex-col shadow-lg sm:p-4 p-1 sm:gap-2 items-center  sm:w-64'>
          <img src={busLogo} alt='busLogo' className='sm:h-40 h-20 sm:w-full w-20 object-cover' />
          <h1 className='text-base sm:text-lg font-semibold'>2000 +</h1>
          <h2 className='text-[8px] sm:text-base font-medium text-gray-500'>Bus Collections</h2>
        </div>
        <div className='flex flex-col shadow-lg sm:p-4 p-1 sm:gap-2 items-center  sm:w-64'>
          <img className='sm:h-40 h-20 sm:w-full w-20 pt-2 px-4 object-cover' src={happyLogo} alt='happyLogo' />
          <h1 className='text-base sm:text-lg font-semibold'>20 Million</h1>
          <h2 className='text-[8px] sm:text-base font-medium text-gray-500'>happy customers globally</h2>
        </div>
        <div className='flex flex-col shadow-lg sm:p-4 p-1 sm:gap-2 items-center sm:w-64'>
          <img className='sm:h-40 h-20 sm:w-full w-20 pt-2 px-4 object-center' src={ticketLogo} alt='ticketLogo' />
          <h1 className='text-base sm:text-lg font-semibold'>5000 +</h1>
          <h2 className='text-[8px] sm:text-base font-medium text-gray-500'>tickets booked everyday</h2>
        </div>
      </div>
      <div>
