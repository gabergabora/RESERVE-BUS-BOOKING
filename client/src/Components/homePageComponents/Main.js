...
export default function Main() {
  ...
  return (
    ...
    style={{ backgroundImage: `url(${main})` }}>
        <div className="flex md:flex-row justify-center items-center pt-[15vh] h-[65vh] rounded-xl ">
            ...
            <div className="border-2 pr-3 py-4 pl-3 rounded-r-xl bg-white">
              ...
              <input type="date" name="date" value={date}
                ...
                className="form-control relative flex-auto min-w-0 block w-[20vw] px-3 py-1.5 sm:text-base text-xs font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
