  ...
  return (
    <div>
        ...
        <section className='flex flex-col justify-between'>
            ...
            <div className='flex sm:gap-4 gap-1'>
                <h1 className='sm:text-lg text-[12px] font-semibold self-center sm:-slate-700'>{props.data.startTime}, {formattedDate}</h1>---
                <h1 className='sm:text-sm text-[8px] font-semibold self-center text-slate-500'>{hour} hrs {min} min</h1>---
                <h1 className='sm:text-lg text-[12px] font-semibold self-center text-slate-700'>{props.data.EndTime}, {formattedDate}</h1>
            </div>
            <div className='flex sm:gap-4 gap-1'>
        ...
        <section className='flex border-l-2 border-grey-400 pl-7 pr-4 flex-col sm:gap-3'>
            ...
            <button onClick={()=>{props.onDetailsClick()}} className='sm:p-2 p-0.5 sm:px-5 bg-orange-500 text-white rounded-md font-semibold sm:text-md text-xs'>View Seat</button>
        </section>
    </div>
        :
